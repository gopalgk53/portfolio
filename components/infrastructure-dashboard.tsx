        ...
        <div className="grid gap-5 lg:grid-cols-2">
          ...
          <article className={`${panel} min-h-[350px]`}>
            ...
            <svg viewBox="0 0 100 60" className="mt-8 h-56 w-full" role="img" aria-label="Simulated tokens per second sparkline">
              ...
              {[15, 30, 45].map((y) => (
                <line key={y} x1="0" x2="100" y1={y} y2={y} stroke="rgba(15,23,42,.1)" strokeWidth=".25" />
              ))}
            ...
            <div className="mt-8 space-y-7">
              {[
                ...
                <div key={label as string}>
                  ...
                  <div className="h-2 overflow-hidden rounded-full border border-[var(--border)] bg-[var(--border)]">
