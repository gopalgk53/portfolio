  ...
  return (
    <section id="pipeline" className="chapter relative z-10 scroll-mt-20 border-t border-[var(--border)] px-5 py-24 sm:px-8 sm:py-32">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-6 surface-card p-6 lg:grid-cols-[1.65fr_.85fr] lg:p-8">
          <div className="relative overflow-x-auto rounded-[var(--radius-sm)] border border-[var(--border)] bg-[linear-gradient(rgba(37,99,235,.06)_1px,transparent_1px),linear-gradient(90deg,rgba(37,99,235,.06)_1px,transparent_1px)] bg-[size:32px_32px] p-6">
            <div className="flex min-w-[850px] items-center gap-3">
              {stages.map((stage, i) => (
                <div className="contents" key={stage.name}>
                  ...
                  {i < stages.length - 1 && (
                    <div className="relative h-px w-7 bg-[var(--border-strong)]">
